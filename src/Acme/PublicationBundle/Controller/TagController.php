...
use Acme\PublicationBundle\Entity\Tag;
use Acme\PublicationBundle\Form\TagType;
...
class TagController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('AcmePublicationBundle:Tag')->findAll();
     ...
     * @Method("POST")
     * @Template("AcmePublicationBundle:Tag:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('AcmePublicationBundle:Tag')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("AcmePublicationBundle:Tag:edit.html.twig")
     */
